...
if ! test -f "/home/runner/.apt/usr/lib/apache2/modules/libphp7.2.so"; then install-pkg libapache2-mod-php7.2; fi
...
/home/runner/.apt/usr/sbin/apache2 -f "$(pwd)/apache2/apache2.conf" -DFOREGROUND